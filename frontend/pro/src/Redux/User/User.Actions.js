...
import { ADD_FRIEND_ERROR, ADD_FRIEND_REQUEST, ADD_FRIEND_SUCCESS,     CANCEL_SEND_FRIEND_REQUEST_REQUEST, CANCEL_SEND_FRIEND_REQUEST_SUCCESS, CHANGE_DP_ERROR, CHANGE_DP_REQUEST, CHANGE_DP_SUCCESS, FRIEND_REQUEST_ERROR, FRIEND_REQUEST_REQUEST, FRIEND_REQUEST_SUCCESS, GET_ALL_FRIENDS_ERROR, GET_ALL_FRIENDS_REQUEST, GET_ALL_FRIENDS_SUCCESS, GET_ALL_USERS_ERROR, GET_ALL_USERS_REQUEST, GET_ALL_USERS_SUCCESS, GET_FRIENDS_PROFILE_ERROR, GET_FRIENDS_PROFILE_REQUEST, GET_FRIENDS_PROFILE_SUCCESS, GET_SINGLE_USER_DATA_ERROR, GET_SINGLE_USER_DATA_REQUEST, GET_SINGLE_USER_DATA_SUCCESS, SEND_FRIEND_REQUEST_ERROR, SEND_FRIEND_REQUEST_REQUEST, SEND_FRIEND_REQUEST_SUCCESS, UPDATE_USER_ERROR, UPDATE_USER_REQUEST, UPDATE_USER_SUCCESS } from './User.ActionTypes'

export const getAllUsers = (id) => dispatch => {
 dispatch({type:GET_ALL_USERS_REQUEST});
 return axios.get(`http://localhost:8080/search/${id}`)
...
export const updateUserFun = (id,userDetails) => dispatch => {
    ...
    return axios.patch(`http://localhost:8080/${id}`,userDetails)
    .then(res => dispatch({type:UPDATE_USER_SUCCESS,payload:res.data.user}))
...
export const getFriendProfile = (id) => dispatch =>{
    ...
    return axios.get(`http://localhost:8080/single/${id}`)
    .then(res => dispatch({type:GET_FRIENDS_PROFILE_SUCCESS,payload:res.data}))
